...
@onready var wireEnd1: Node2D = $WireEnd
@onready var wireEnd2: Node2D = $WireEnd2
...
func _ready() -> void:
	var drag1 = wireEnd1.get_node("Entire")
	var drag2 = wireEnd2.get_node("Entire")
	drag1.input_event.connect(_on_drag_area_input_event.bind(wireEnd1))
	drag2.input_event.connect(_on_drag_area_input_event.bind(wireEnd2))
...
func updateWire() -> void:
	var pos1 = wireEnd1.position + Vector2(-10, -20)
	var pos2 = wireEnd2.position + Vector2(35, -20)
